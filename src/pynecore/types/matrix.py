...
class Matrix(Generic[T]):
    ...
    def concat(self, other: 'Matrix[T]') -> 'Matrix[T]':
        """
    ...
    def diff(self, other: 'Matrix[T]' | int | float) -> 'Matrix[T]':
        """
    ...
    def mult(self, other: 'Matrix[T]' | list[T] | int | float) -> 'Matrix[T]' | list[T]:
        """
    ...
    def sum(self, other: 'Matrix[T]' | int | float) -> 'Matrix[T]':
        """
    ...
    def pow(self, power: int) -> 'Matrix[T]':
        """
